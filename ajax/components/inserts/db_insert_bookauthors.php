...
//     {
//         Key: "bookId"
//         Value: the books database id (i.e., ISBN) - should be able to be converted into type varchar(13)
...
// REMOVE - TO DO 🔲
ChromePhp::log("Added to bookauthors: new bookauthors's id=$insert_id");
